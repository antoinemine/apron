...
#ifdef QSORT_EXTRA_CMP_ARGUMENT
void qsort2(void *base_ptr, size_t count, size_t size, qsort2_cmp cmp,
	    void *cmp_argument)
#else
void qsort(void *base_ptr, size_t count, size_t size, qsort_cmp cmp)
#endif
{
  char *low, *high, *pivot;
