...
/* ====================================================================== */
bool eitvXXX_canonicalize(itv_internal_t intern, eitvXXX_t a, bool integer);
...
static inline bool eitvXXX_is_bottom(itv_internal_t intern, eitvXXX_t a);
...
static inline void eitvXXX_range_abs(boundXXX_t a, eitvXXX_t b);
  /* a=(max b - min b) */
static inline void eitvXXX_range_rel(itv_internal_t intern, boundXXX_t a, eitvXXX_t b);
  /* a=(max b - min b) / (|a+b|/2) */

/* ====================================================================== */
/* Lattice operations */
/* ====================================================================== */
static inline bool eitvXXX_meet(itv_internal_t intern, eitvXXX_t a, eitvXXX_t b, eitvXXX_t c);
...
static inline bool eitvXXX_sqrt(itv_internal_t intern, eitvXXX_t a, eitvXXX_t b);
...
static inline void eitvXXX_mod(itv_internal_t intern, eitvXXX_t a, eitvXXX_t b, eitvXXX_t c, bool is_int);
...
static inline void eitvXXX_mod(itv_internal_t intern,
