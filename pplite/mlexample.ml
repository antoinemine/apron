...
printf "Using Library: %s, version %s@.\n"
    (Manager.get_library man) (Manager.get_version man);;

printf "Current PPLite's poly kind = %s\n" (Pplite.manager_get_kind man);;
printf "\n%!";;
...
(* Testing the get/set polyhedron kind functions *)

printf "\n\nSetting PPLite's poly kind to %s ...\n" ("F_Poly");;
Pplite.manager_set_kind man "F_Poly";;
printf "PPLite's poly kind set to %s\n" (Pplite.manager_get_kind man);;
printf "\n%!";;
