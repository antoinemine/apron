...
%**********************************************************************
\chapter{Sémantique concrète au niveau 0}
%**********************************************************************

\nwenddocs{}\nwbegincode{1}\moddef{expr0.h}\endmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
/* ************************************************************************* */
/* expr0.h: linear expressions, constraints and generators */
/* ************************************************************************* */
...
{\Tt{}linexpr0{\_}t} est toujours déclaré comme un pointeur
({\Tt{}linexpr0{\_}t*\ expr}), et alloué ou libéré par %
{\Tt{}linexpr0{\_}t*\ linexpr0{\_}alloc(...)} et
{\Tt{}linexpr0{\_}free(linexpr0{\_}t*)}. A noter, on a mis les coefficients
...
{\Tt{}linexpr0{\_}t} est considéré comme un type abstrait, même par
l'implémenteur d'une librairie.

Les autres types ({\Tt{}lincons0{\_}t},{\Tt{}lincons0{\_}array{\_}t},
{\Tt{}generator0{\_}t} et {\Tt{}generator0{\_}array{\_}t}) sont manipulés via des
pointeurs, mais déclarés ``en-ligne'' ({\Tt{}X{\_}t\ obj;}), avec des
fonctions d'initialisation et de nettoyage {\Tt{}void\ X{\_}init(X{\_}t*)}
et {\Tt{}void\ X{\_}clear(X{\_}t*)}.
...
sur une fonction d'affectation du type {\Tt{}abstract{\_}t*\nwnewline
abstract{\_}assign{\_}linexpr0(abstract{\_}t*\ a,\ dim{\_}t\ dim,\ linexpr0{\_}t\nwnewline
expr)}.
\begin{enumerate}
\item La fonction {\Tt{}abstract{\_}assign{\_}linexpr0} prend en entrée le
  type public des expressions {\Tt{}linexpr0{\_}t} et effectue la
...
\item Il existe dans l'interface un type interne (opaque)
  ...
  constructeurs nécessaires), et {\Tt{}abstract{\_}assign{\_}linexpr0} prend
...
donc d'aucun exemple sous la main. Le type {\Tt{}generator0{\_}t} permet en
