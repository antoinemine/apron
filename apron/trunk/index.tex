...
(presented at the \xlink{SAS
  2007}{http://www2.imm.dtu.dk/sas2007/}). You may also read the
associated \xlink{flyer}{flyer.pdf}.

Currently, APRON provides a C interface and an \ocaml interface.
There also exists a C++ interface, which is more experimental.

The version 0.9.9 (9th june 2008) contains 3 libraries and 4 abstract domains:
\begin{itemize}
...
\begin{itemize}
\item On-line \xlink{C interface}{http://apron.cri.ensmp.fr/library/0.9.9/apron/apron.html} and \xlink{OCaml interface}{http://apron.cri.ensmp.fr/library/0.9.9/mlapronidl/index.html};
\item \xlink{C pdf}{http://apron.cri.ensmp.fr/library/0.9.9/apron.pdf} or \xlink{OCaml pdf}{http://apron.cri.ensmp.fr/library/0.9.9/mlapronidl.pdf};
\item \xlink{C example}{http://apron.cri.ensmp.fr/library/0.9.9/example1.c} or \xlink{OCaml example 1}{http://apron.cri.ensmp.fr/library/0.9.9/mlexample1.ml}/\xlink{OCaml example 2}{http://apron.cri.ensmp.fr/library/0.9.9/mlexample2.ml}/\xlink{OCaml example 3}{http://apron.cri.ensmp.fr/library/0.9.9/mlexample3.ml}. For the
...
\subsection{Current version: 0.9.9}
...
\item You can also access to the \xlink{SUBVERSION
    REPOSITORY}{http://svn.cri.ensmp.fr/svn/apron/}, by typing
  something like \kbd{svn list
    http://svn.cri.ensmp.fr/svn/apron/trunk}.
\end{itemize}
