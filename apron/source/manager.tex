...
\nwenddocs{}\nwbegincode{3}\moddef{manager.h}\plusendmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
numéro, allant de {\Tt{}0} à {\Tt{}FUNID{\_}SIZE-1}. Les motivations sont les
suivantes:
\begin{description}
...
\nwenddocs{}\nwbegincode{5}\moddef{manager.h}\plusendmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
%----------------------------------------------------------------------
\point{Type} le type {\Tt{}exception{\_}t} est défini comme suit:

\nwenddocs{}\nwbegincode{7}\moddef{manager.h}\plusendmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{9}\moddef{manager.h}\plusendmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{11}\moddef{manager.h}\plusendmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
Le type {\Tt{}manager{\_}t} est structuré comme suit:
\nwenddocs{}\nwbegincode{13}\moddef{manager.h}\plusendmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
opérations du module {\Tt{}abstract0} sont génériques.
...
virtuelle et le champ {\Tt{}internal} si la librairie en a l'usage.

%======================================================================
\section{Fonctions d'accès}
%======================================================================

\nwenddocs{}\nwbegincode{17}\moddef{manager.h}\plusendmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{19}\moddef{manager.h}\plusendmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{21}\moddef{manager.h}\plusendmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
...
\nwenddocs{}\nwbegincode{23}\moddef{manager.h}\plusendmoddef\nwstartdeflinemarkup\nwenddeflinemarkup
#endif
\nwendcode{}\nwbegindocs{24}\nwdocspar
\nwenddocs{}
