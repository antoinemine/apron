...
int main(void) {
    ...
    //   ap_abstract1_fprint(stdout, man, &if_then_else[0]);
    ...
    ap_abstract1_fprint(stdout, man, &if_then_else[1]);
    gamma = ap_abstract1_to_box(man, &if_then_else[1]);
    ...
    ap_abstract1_fprint(stdout, man, &if_then_else[2]);
    gamma = ap_abstract1_to_box(man, &if_then_else[2]);
    ap_box1_fprint(stdout, &gamma);

    ap_abstract1_t toto = ap_abstract1_join(man, false, &if_then_else[1], &if_then_else[2]);
    ap_abstract1_fprint(stdout, man, &toto);
    gamma = ap_abstract1_to_box(man, &toto);
    ap_box1_fprint(stdout, &gamma);
    //    ap_abstract1_t titi = ap_abstract1_join(man, false, &if_then_else[0], &toto);
    //    ap_abstract1_fprint(stdout, man, &titi);
    /********* JOIN **************/
    ...
    gamma = ap_abstract1_to_box(man, &res);
