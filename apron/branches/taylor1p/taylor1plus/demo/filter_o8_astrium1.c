...
void filter1(ap_manager_t* man, int *N, double *inf, double *sup, FILE* stream, double *cpu_time_used) 
{
	...
	*/
	...
	ap_box1_t box;
	ap_abstract1_t _35,_36,_37,_38,_39,_40,_41,_42,_43,_44,_45,_46,_47,_48,_49,_50,_51,_52,_53,_54,_55,_56,_57,_58,_59,pivot,_k1,_k2, pivot2, fix, init;
	i = 0;
	...
	if (T1P)
	{
				...
				init = ap_abstract1_join_array(man, array, INITIAL_UNFOLD+THRESHOLD);
