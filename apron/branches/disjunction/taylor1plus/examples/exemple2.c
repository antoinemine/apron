...
int main(void) {
    ...
    ap_interval_set_double(array[1], 2.0, 2.0);	/* array[1] = [2,2] */
    ap_interval_set_double(array[2], 3, 3);	/* array[2] = [-1,-1] */
    ...
    ap_box1_t gamma = ap_abstract1_to_box(man, &abstract1);
    ...
    ap_linexpr1_set_coeff_scalar_double(&linexp, "z", (double)(2.0));
    ...
    ap_lincons1_array_fprint(stdout, &cons_array);
    ...
    gamma = ap_abstract1_to_box(man, &abstract2);
    ap_box1_fprint(stdout, &gamma);
    ap_box1_clear(&gamma);
