...
*/
	ap_linexpr1_set_list(&h,
			AP_COEFF_I_FRAC, 1, 1, 1,1,"E",
			AP_COEFF_I_FRAC, 0, 1, 0, 1,"E0",
			AP_COEFF_I_FRAC, 0, 1, 0, 1,"E1",
			AP_COEFF_I_FRAC, -1, 1, -1, 1,"S0",
			AP_COEFF_I_FRAC, -1, 2, -1, 2,"S1",
			AP_END);
