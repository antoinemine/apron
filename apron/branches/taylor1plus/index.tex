...
\item You can also access to the (new) \xlink{SUBVERSION
    REPOSITORY}{https://gforge.inria.fr/scm/viewvc.php/?root=apron},
  by typing something like
  \begin{quote}
  \kbd{svn list scm.gforge.inria.fr/svnroot/apron}.
  \end{quote}
  If you want to download to the last committed version:
  \begin{quote}
  \kbd{svn co scm.gforge.inria.fr/svnroot/apron/apron/trunk apron}.
  \end{quote}
  If you want to access the distribution which references both APRON and MLGMPIDL (using subversion external links):
  \begin{quote}
    \kbd{svn co scm.gforge.inria.fr/svnroot/apron/apron-dist/trunk apron-dist}.
  \end{quote}
