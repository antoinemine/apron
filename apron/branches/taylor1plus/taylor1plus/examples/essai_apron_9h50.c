...
int main(void) {
    ...
    ap_interval_set_double(array[0], 0, 100);
    ...
    ap_linexpr1_set_cst_scalar_double(&linexp1, (double)50.0);
    ...
    ap_linexpr1_set_cst_scalar_double(&linexp2, (double)-50.0);
    ...
    ap_texpr1_t* y1 = ap_texpr1_binop(AP_TEXPR_MUL,
	    ap_texpr1_cst_scalar_double(env, 0.5),
	    ap_texpr1_var(env, "x"),
	    AP_RTYPE_DOUBLE,
	    AP_RDIR_UP);

    ap_texpr1_t* x1 = ap_texpr1_binop(AP_TEXPR_MUL,
	    ap_texpr1_var(env, "x"),
    ...
    ap_texpr1_t* y2 = ap_texpr1_binop(AP_TEXPR_MUL,
	    ap_texpr1_cst_scalar_double(env, 0.75),
	    ap_texpr1_var(env, "x"),
	    AP_RTYPE_DOUBLE,
	    AP_RDIR_UP);

    ap_texpr1_t* x2 = ap_texpr1_binop(AP_TEXPR_MUL,
	    ap_texpr1_var(env, "y"),
	    ap_texpr1_binop(AP_TEXPR_SUB,
		ap_texpr1_var(env, "x"),
		ap_texpr1_var(env, "y"),
    ...
    /********* ASSIGN y = 0.5*x; *********/
    ap_abstract1_t abs2 = ap_abstract1_assign_texpr(man, false, &abs1, "y", y1, NULL);
    /********* ASSIGN x = (x-y)*x; *********/
    ap_abstract1_t abs3 = ap_abstract1_assign_texpr(man, false, &abs2, "x", x1, NULL);

    /********** ELSE **************/
    ap_abstract1_t abs4 = ap_abstract1_meet_lincons_array(man, false, &abs, &cons2_array);
    /********* ASSIGN y = 0.5*x; *********/
    ap_abstract1_t abs5 = ap_abstract1_assign_texpr(man, false, &abs4, "y", y2, NULL);
    /********* ASSIGN x = (x-y)*x; *********/
    ap_abstract1_t abs6 = ap_abstract1_assign_texpr(man, false, &abs5, "x", x2, NULL);

    /*********** JOIN ***********/
    ap_abstract1_t abs7 = ap_abstract1_join(man, false, &abs3, &abs6);
    /* pour afficher le resultat */
    ap_abstract1_fprint(stdout, man, &abs7);
    /* pour afficher la concretisation intervalle de abs_res */
    gamma = ap_abstract1_to_box(man, &abs7);
