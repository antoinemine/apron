...
int main(void) {
    ...
    ap_linexpr1_set_coeff_scalar_double(&mdmr, "d", (double)(-1.0));
    ...
    ap_linexpr1_set_coeff_scalar_double(&rmd, "d", (double)(-1.0));
    ...
    ap_linexpr1_set_coeff_scalar_double(&rpd, "d", (double)(1.0));
    ...
    ap_linexpr1_set_coeff_scalar_double(&smd, "d", (double)(-1.0));
    ...
    ap_linexpr1_set_coeff_scalar_double(&spd, "d", (double)(1.0));
	...
	abs7 = ap_abstract1_assign_linexpr(man, false, &abs6, "y", &spd, NULL);
