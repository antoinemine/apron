...
int main(void) {
    ...
    ap_interval_set_top(array[1]);	/* array[1] = [2,2] */
    ...
    ap_linexpr1_t ymx = ap_linexpr1_make(env, AP_LINEXPR_SPARSE, (size_t)2);
    ap_linexpr1_set_cst_scalar_double(&ymx, (double)0.0);
    ap_linexpr1_set_coeff_scalar_double(&ymx, "y", (double)(1.0));
    ap_linexpr1_set_coeff_scalar_double(&ymx, "x", (double)(-1.0));
    ...
    ap_lincons1_t cons_ymx = ap_lincons1_make(AP_CONS_SUPEQ, &ymx, NULL);
    ...
    ap_box1_t gamma = ap_abstract1_to_box(man, &abs6);
