...
//    ap_abstract1_fprint(stdout, man, &abs);
    ...
    ap_texpr1_t* dixxx = ap_texpr1_binop(AP_TEXPR_MUL,
    ...
    ap_texpr1_t* vinxx = ap_texpr1_binop(AP_TEXPR_MUL,
	    ap_texpr1_binop(AP_TEXPR_MUL,
		ap_texpr1_var(env, "x"),
		ap_texpr1_var(env, "x"),
		AP_RTYPE_DOUBLE,
		AP_RDIR_UP),
	    ap_texpr1_cst_scalar_double(env, -20.0),
	    AP_RTYPE_DOUBLE,
	    AP_RDIR_UP);
    ...
    abs2 = ap_abstract1_assign_texpr(man, false, &abs1, "y", dixxx, NULL);
    abs3 = ap_abstract1_meet_lincons_array(man, false, &abs, &cons_else);
    abs4 = ap_abstract1_assign_texpr(man, false, &abs3, "y", vinxx, NULL);
