...
/***********************************/
/*  Equations for alternative join */
/***********************************/
...
typedef struct _t1p_internal_t {
    ...
    ja_eq_set_t* exact_eqs; /* equation exacte pour join alt */
} t1p_internal_t;
...
static inline void t1p_aff_add_aff(t1p_internal_t* pr, t1p_aff_t *a,  t1p_aff_t *b, t1p_aff_t *c)
{
  ...
  itv_t temp;
#ifdef _T1P_DEBUG
  printf("%d symbols in aff1\n",(int)aux_b->l);
  printf("%d symbols in aff2\n",(int)aux_c->l);	  
#endif
