...
#ifndef _ITVP_CONFIG_H_
#define _ITVP_CONFIG_H_

#include <sys/time.h>

extern int nlpcreate_itvp;
extern int nlpdel_itvp;
extern int nlp_itvp;
extern int nlpjoin_itvp;
extern int nslp_itvp;
extern int nrlp_itvp;
extern int nstrongjoin_itvp;
extern int nweakjoin_itvp;
extern int maxCons_itvp;
...
/*including the function definition somewhere in the compilation (but don't call it!)
  for the 'floating point code not linked' problem */
